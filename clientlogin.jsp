  ...
  <div id="pageintro" class="hoc clear">
    <div class="flexslider basicslider"> 
	  ...
	  <div class="content three_quarter">
			<form action="clientlogincheck.jsp" method="post">
				<table>
					<h1 style="padding-left: 125px;padding-bottom: 10px;">Client Login </h1>
					<tr>
						<th height="50"><label>UserName</label></th>
						<td style="background-color: #929292;background-color: rgb(44, 45, 42);">
						<input style="background-color: rgba(255,255,255,.4);" type="text" name="cemail" placeholder="" required></td>
					</tr>
					<tr>
					...
					<tr>
						<td style="padding-left: 40px;background-color: #373737;">Not yet registered?   <a href="clientreg.jsp">Signup</a> here</td>
