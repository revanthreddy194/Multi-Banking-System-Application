...
<div class="bgded overlay" style="background-image:url('images/demo/backgrounds/dwn2.jpg');"> 
  ...
  <div id="breadcrumb" class="hoc clear" style="padding-top: 50px;"> 
    ...
    <ul>
      ...
      <li><a href="#">Pending Banker Requests</a></li>
    </ul>
    <!-- ################################################################################################ -->
  </div>
...
<div class="wrapper row3">
  <main class="hoc container clear"> 
	...
	<div class="content three_quarter"> 
      <!-- ################################################################################################ -->
		<h1>Pending New Banker Requests</h1>
        ...
        <table>
          <thead>
            <tr>
			  ...
			  <th>Action</th>
					...
					<%
						...
						String sql="select bid,bname,bemail,bbranch,bheadoff,bphoneno from bank where baccstatus='waiting'";
            ...
            <tr>
				...
				<td><%=rs.getString("bbranch")%></td>
				<td><%=rs.getString("bheadoff")%></td>
                <td><%=rs.getString("bphoneno")%></td>
				<td><a href="serverbankreq_accept.jsp?id=<%=rs.getString("bid")%>"><span>Accept</span>
								</a>/<a href="serverbankreq_reject.jsp?id=<%=rs.getString("bid")%>"><span>Reject</span></a>
				</td>
           </tr>
					<%}
					%>
