            ...
            <tr>
			  ...
			  <th>Status </th>
					...
					<%
						...
						String sql1="select bname from currentbank where const='const'";
						...
						String sql="select id,tdate,debitaccnum,debitaccbank,debitcemail,amount,creditaccnum,creditaccbank,creditcemail,status from transactions where debitaccbank=? OR creditaccbank=?";
