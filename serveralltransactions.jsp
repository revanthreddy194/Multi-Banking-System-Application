...
<div class="bgded overlay" style="background-image:url('images/demo/backgrounds/dwn2.jpg');"> 
  ...
  <div id="breadcrumb" class="hoc clear" style="padding-top: 50px;"> 
    ...
    <ul>
	  ...
	  <li><a href="serveroptions.jsp">Server</a></li>	  
            ...
            <tr>
              ...
              <th>Creditor Bank</th>
					...
					<%
						...
						String sql="select id,tdate,amount,debitaccnum,debitaccholder,debitcemail,debitaccbank,creditaccnum,creditaccholder,creditcemail,creditaccbank from transactions";
