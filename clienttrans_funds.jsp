...
<div class="wrapper row3">
  <main class="hoc container clear"> 
	...
	<div class="content three_quarter"> 
      <!-- ################################################################################################ -->
		<h1>Initiate Funds Transfer</h1>
        <div class="scrollable">
        <form action="clienttrans_funds_otp.jsp" method="post">
		<table>
          <thead>
			<tr>
              <th><label>Date</label></th>
			  <td><input type="date" name="tdate" placeholder="" required></td>
			</tr>
			<tr>
              <th><label>Debitor Account Number</label></th>
			  <td><input type="number" name="debitaccnum" placeholder="" required></td>
			</tr>
			<tr>
              <th><label>Debitor Bank Name***</label></th>
			  <td><select name="debitaccbank">
			...
			<tr>
              <th><label>Debitor Email ID***</label></th>
			  <td><input type="email" name="debitcemail" placeholder="" required></td>
			</tr>
			<tr>
              <th><label>Debitor Account Name</label></th>
			  <td><input type="text" name="debitaccholder" placeholder="" required></td>
			</tr>
            <tr>
              <th><label>Creditor Account Number</label></th>
			  <td><input type="number" name="creditaccnum" placeholder="" required></td>
			</tr>
			<tr>
              <th><label>Creditor Bank Name***</label></th>
			  <td><select name="creditaccbank">
					<option value="sbi">SBI</option>
					<option value="canara">Canara Bank</option>
					<option value="andhra">Andhra bank</option>
					<option value="uco">Uco Bank</option>
			...
			<tr>
              <th><label>Creditor Email ID***</label></th>
			  <td><input type="email" name="creditcemail" placeholder="" required></td>
			</tr>
			<tr>
              <th><label>Creditor Account Name</label></th>
			  <td><input type="text" name="creditaccholder" placeholder="" required></td>
			</tr>
			<tr>
