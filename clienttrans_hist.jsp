        ...
        <table>
          <thead>
            <tr>
			  ...
			  <th>Status</th>
					...
					<%
						...
						String sql1="select cemail from currentclient where const='const'";
						...
						String sql="select tdate,id,creditaccnum,creditaccholder,creditaccbank,creditcemail,amount,status from transactions where debitcemail=?";
            ...
            <tr>
				...
				<td><%=rs.getString("creditaccnum")%></td>
				<td><%=rs.getString("creditaccholder")%></td>
