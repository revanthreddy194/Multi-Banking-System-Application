  ...
  <main class="hoc container clear"> 
	...
	<div class="content three_quarter"> 
	  ...
	  <%@page import="java.sql.*"%>
        ...
        <form action="clienttrans_funds_otpcheck2.jsp" method="post">
		<table>
          <thead>
			<tr><td><input type="hidden" name="debitcemail" value="<%=debitcemail%>"></td></tr>
			<tr>
              <th><label>Enter the OTP which you had received through mail.</label></th>
			  <td><input type="number" name="otp" placeholder="" required></td>
			</tr>
